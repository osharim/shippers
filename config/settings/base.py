...
)  # (sendengo/config/settings/base.py - 3 = sendengo/)
APPS_DIR = ROOT_DIR.path("sendengo")
...
MIGRATION_MODULES = {"sites": "sendengo.contrib.sites.migrations"}
...
ADMINS = [("""osharim""", "omar.sh.bentel@gmail.com")]
...
JET_SIDE_MENU_ITEMS = [
    ...
    {'label': "Administración de cuentas", 'items': [{'name': 'users.user'}, ]},
